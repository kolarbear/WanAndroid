...
public class HomeArticle {
    ...
    public static class DatasBean {
         ...
         * fresh : false
         * id : 2918
         * link : https://mp.weixin.qq.com/s/r8wlKaNsWdffGxuGkpoXbQ
         * niceDate : 2018-05-14
         * origin :
         * projectLink :
         * publishTime : 1526305420000
         * superChapterId : 30
